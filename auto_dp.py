...
from DaisyX.utils import edit_or_reply, admin_cmd

from DaisyX import ALIVE_NAME, CMD_HELP, BIO_MSG


DEFAULTUSERBIO = str(BIO_MSG) if BIO_MSG else "ʟɛɢɛռɖaʀʏ ᴀғ ᴅᴀɪsʏ χ"
DEL_TIME_OUT = 60
